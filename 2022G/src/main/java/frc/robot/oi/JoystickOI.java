...
import frc.robot.commands.ClimbCommands.ExtendBothArms;
import frc.robot.commands.ClimbCommands.ExtendRightArm;
import frc.robot.commands.ClimbCommands.ExtendThirdArm;
import frc.robot.commands.ClimbCommands.RetractBothArms;
...
public class JoystickOI {
  ...
  public void configureJoysticks() {
    ...
    rightButton3.whenHeld(new ExtendBothArms()).whenReleased(new RetractBothArms());
    rightButton4.whenPressed(new ExtendThirdArm());
