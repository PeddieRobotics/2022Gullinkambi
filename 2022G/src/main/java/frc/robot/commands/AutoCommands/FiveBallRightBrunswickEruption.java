...
public class FiveBallRightBrunswickEruption  extends SequentialCommandGroup{
    public FiveBallRightBrunswickEruption(Pose2d initialPose, RamseteCommand part1, RamseteCommand part2, RamseteCommand part3, RamseteCommand part4){
        addCommands(
            new ResetOdometry(initialPose),
            new SetFlywheelRPM(2550),
