...
public class FiveBallRightDCMP extends SequentialCommandGroup{ 

    public FiveBallRightDCMP(Pose2d initialPose, RamseteCommand part1, RamseteCommand part2, RamseteCommand part3, RamseteCommand part4){
        addCommands(
