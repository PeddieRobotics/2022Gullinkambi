...
public class TwoBallTwoTrollHangarShort extends SequentialCommandGroup{
    public TwoBallTwoTrollHangarShort(Pose2d initialPose, RamseteCommand part1, RamseteCommand part2, RamseteCommand part3){
        addCommands(
