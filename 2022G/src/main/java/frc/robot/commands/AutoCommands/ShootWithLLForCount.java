...
import frc.robot.commands.ShootCommands.FlywheelEdgeDetection;
import frc.robot.commands.ShootCommands.ShootWithLL;
import frc.robot.commands.ShootCommands.Target;
import frc.robot.subsystems.Drivetrain;

public class ShootWithLLForCount extends SequentialCommandGroup{

    public ShootWithLLForCount(int count) {
        addCommands(    
            new ParallelRaceGroup(
                ...
                new FlywheelEdgeDetection(count))
        );
    }
