...
public class TwoBallTwoTrollShortHangar extends SequentialCommandGroup{
    public TwoBallTwoTrollShortHangar(Pose2d initialPose, RamseteCommand part1, RamseteCommand part2, RamseteCommand part3){
        addCommands(
