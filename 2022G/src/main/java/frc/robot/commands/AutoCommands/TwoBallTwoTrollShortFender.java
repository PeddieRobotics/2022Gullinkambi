...
public class TwoBallTwoTrollShortFender extends SequentialCommandGroup{
    public TwoBallTwoTrollShortFender(Pose2d initialPose, RamseteCommand part1, RamseteCommand part2, RamseteCommand part3){
        addCommands(
