...
public class SplitFFRamseteCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if (m_usePID) {
      double leftFeedforward = m_leftFeedforward.calculate(
          leftSpeedSetpoint, (leftSpeedSetpoint - m_prevSpeeds.leftMetersPerSecond) / dt);

      double rightFeedforward = m_rightFeedforward.calculate(
